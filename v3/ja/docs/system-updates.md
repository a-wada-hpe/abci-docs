...
2025年度末から、通信許可に期限が設定されることになりました。2025年度以降、通信許可は、通信を申請した期間の終了日（または最長で年度末）に削除されます。2026年度以降は、毎年、通信許可を申請してください。

通信許可の申請手順の詳細については、「各種申請」の[外部ネットワークとの通信の申請](../requests/external-networks/)を参照ください。
